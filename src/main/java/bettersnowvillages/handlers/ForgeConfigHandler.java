...
public class ForgeConfigHandler {
	...
	@MixinConfig(name = BetterSnowVillages.MODID) //Needed on config classes that contain MixinToggles for those mixins to be added
	public static class ServerConfig {
		...
		@MixinConfig.MixinToggle(earlyMixin = "mixins.bettersnowvillages.vanilla.json", defaultValue = false)
...
//		@MixinConfig.MixinToggle(lateMixin = "mixins.bettersnowvillages.jei.json", defaultValue = false)
