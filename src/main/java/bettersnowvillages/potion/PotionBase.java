package bettersnowvillages.potion;
...
public abstract class PotionBase extends Potion {
    ...
    public PotionBase(String name, boolean isBadEffect, int liquidColor) {
        ...
        this.texture = new ResourceLocation(BetterSnowVillages.MODID, "textures/effects/" + name + ".png");
        this.setRegistryName(BetterSnowVillages.MODID, name);
        this.setPotionName("effects." + BetterSnowVillages.MODID + "." + name);
    }
