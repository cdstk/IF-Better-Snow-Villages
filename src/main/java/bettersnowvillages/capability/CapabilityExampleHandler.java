package bettersnowvillages.capability;
...
public class CapabilityExampleHandler {
    public static final ResourceLocation CAP_EXAMPLE_KEY = new ResourceLocation(BetterSnowVillages.MODID, "example");
    ...
    public static class EventHandler {
        ...
        public static void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
            if(!BetterSnowVillages.completedLoading) return; //only needed when other mods instantiate objects during startup that would get the capability (example: JEI creating ItemStacks)
